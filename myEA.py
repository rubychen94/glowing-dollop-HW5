...
"""
debug =0
#D:\物聯網應用與資料分析\hw5\Part 1 =PHP for AI\Part 1 =PHP for AI\IoT  Web L14(ans)\AI module (local)\myEA.py
...
data=pd.read_csv("trainN.csv")  #非線性 using trainN.csv
...
#====== 執行 MySQL 查詢指令 ======#
#c.execute("SELECT * FROMINSERT INTO sensors (light)VALUES(RAND()*1000); sensors")
c.execute("")
#====== 取回所有查詢結果 ======#
results = c.fetchall()
print(type(results))
